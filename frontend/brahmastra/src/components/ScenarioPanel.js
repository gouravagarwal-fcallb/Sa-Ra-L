...
const styles = {
  ...
  instrument: { fontSize: 14, fontWeight: 700 },
  direction: { fontSize: 13, fontWeight: 700 },
  stateBadge: {
  ...
  hyp: { fontSize: 12, color: '#94a3b8', flex: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' },
  barTrack: {
  ...
  levelLabel: { fontSize: 11, color: '#475569', letterSpacing: 1 },
  levelVal: { fontSize: 12, fontWeight: 700 },
  pnl: { fontSize: 14, fontWeight: 700, textAlign: 'right', marginTop: 2 },
};
