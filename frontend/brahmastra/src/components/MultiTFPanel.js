...
const styles = {
  ...
  colInst: { fontSize: 11, fontWeight: 700, color: '#94a3b8', letterSpacing: 1 },
  colTf:   { fontSize: 10, color: '#475569', letterSpacing: 1 },
  rowLabel: { fontSize: 11, color: '#475569', letterSpacing: 1 },
  cell: {
    fontSize: 11, fontWeight: 700, textAlign: 'center',
    background: '#1e293b', borderRadius: 3, padding: '4px 4px',
    letterSpacing: 0.5,
  },
};
